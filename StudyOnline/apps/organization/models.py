...
class CourseOrg(models.Model):
	...
	desc=models.CharField('机构描述',max_length=200)
	category=models.CharField(max_length=20,choices=ORG_CHOICES,verbose_name=u"机构类别",default="gr")
...
class Teacher(models.Model):
	...
	work_positon=models.CharField('公司职位',max_length=50)
